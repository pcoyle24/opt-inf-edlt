...
% cd /mq/philiprojects/RA_Work/Taisuke_Nakata/Zero_Lower_Bound/DeflationaryRegime/OptInf/draft/Figs/Fig_3
% IRFs_demand_shock
%--------------------------------------------------------------------------
...
print(fig(1),'-depsc',strcat(savedir,'demand_only_IRFs.eps'));
