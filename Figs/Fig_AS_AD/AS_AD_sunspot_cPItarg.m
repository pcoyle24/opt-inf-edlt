%--------------------------------------------------------------------------
% File Name: AS_AD_sunspot_cPItarg.m
% Author: Philip Coyle
...
% print(fig(1),'-depsc','AS_AD_plot_cALPHAstar_sunspot.eps');
% print(fig(1),'-depsc',strcat(savedir,'AS_AD_plot_cALPHAstar_sunspot.eps'));
print(fig(1),'-depsc','AS_AD_plot_cALPHAstar_sunspot_largeax.eps');
print(fig(1),'-depsc',strcat(savedir,'AS_AD_plot_cALPHAstar_sunspot_largeax.eps'));
