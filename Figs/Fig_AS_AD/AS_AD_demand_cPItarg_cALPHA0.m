%--------------------------------------------------------------------------
% File Name: AS_AD_demand_cPItarg_cALPHA0.m
% Author: Philip Coyle
...
print(fig(1),'-depsc','AS_AD_plot_cALPHAstar_demand_cALPHA0.eps');
print(fig(1),'-depsc',strcat(savedir,'AS_AD_plot_cALPHAstar_demand_cALPHA0.eps'));