%--------------------------------------------------------------------------
% File Name: AS_AD_sunspot_cPItarg_cALPHA1.m
% Author: Philip Coyle
...
print(fig(1),'-depsc','AS_AD_plot_cALPHAstar_sunspot_cALPHA1.eps');
print(fig(1),'-depsc',strcat(savedir,'AS_AD_plot_cALPHAstar_sunspot_cALPHA1.eps'));
