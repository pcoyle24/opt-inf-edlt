...
for cc = 1:length(c_check_grid)
    ...
    hold on
    if c_check == 0
        fill([-50,150,150,-50],[400*(pi_grid(zlb_inx-1)-1),400*(pi_grid(zlb_inx-1)-1),15,15],[0.85 0.85 0.85]);
    elseif c_check == 1
    ...
    if c_check == 0
        set(gca,'Xlim',[-50 150],'FontSize',15)
    end
...
%         L = legend([hh(1) hh(2)],'Phillips Curve','Euler Equation');
        ...
        set(L,'Location','NorthEast','FontSize',15)
