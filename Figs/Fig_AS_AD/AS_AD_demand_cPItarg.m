%--------------------------------------------------------------------------
% File Name: AS_AD_demand_cPItarg.m
% Author: Philip Coyle
...
% print(fig(1),'-depsc','AS_AD_plot_cALPHAstar_demand.eps');
% print(fig(1),'-depsc',strcat(savedir,'AS_AD_plot_cALPHAstar_demand.eps'));
print(fig(1),'-depsc','AS_AD_plot_cALPHAstar_demand_largeax.eps');
print(fig(1),'-depsc',strcat(savedir,'AS_AD_plot_cALPHAstar_demand_largeax.eps'));