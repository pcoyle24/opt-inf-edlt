...
% cd /mq/philipprojects/RA_Work/Taisuke_Nakata/Zero_Lower_Bound/DeflationaryRegime/draft/Figs/SA/OptInf05/SA_Fig_4
% IRFs_sun_shock.m
%--------------------------------------------------------------------------
...
pi_targ_string = {'0% Inflation Target', '0.5% Inflation Target'};
colors = {'k','b'};
...
print(fig(1),'-depsc','sunspot_only_IRFs.eps');