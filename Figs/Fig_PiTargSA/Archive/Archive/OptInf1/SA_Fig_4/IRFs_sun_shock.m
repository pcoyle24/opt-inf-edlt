...
% cd /mq/philipprojects/RA_Work/Taisuke_Nakata/Zero_Lower_Bound/DeflationaryRegime/draft/Figs/SA/OptInf1/SA_Fig_4
% IRFs_sun_shock.m
%--------------------------------------------------------------------------
...
pi_targ_string = {'0% Inflation Target', '1% Inflation Target'};
colors = {'k','b'};
