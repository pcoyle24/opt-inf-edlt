...
% cd /mq/philipprojects/RA_Work/Taisuke_Nakata/Zero_Lower_Bound/DeflationaryRegime/draft/Figs/min_inf_targ
% find_min_inftarg_sun_demand.m
%--------------------------------------------------------------------------

name = {'pc_07','pc_08','pc_085','pz_099','pz_09925','pz_09975','pitarg_05','pitarg_1','pitarg_15'};

load(strcat('params_',name{k},'.mat'))
...
save(strcat('eqm_exist_sun_demand_',name{k},'.mat'),'min_inf_targ');
