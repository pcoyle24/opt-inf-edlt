...
% cd /mq/philiprojects/RA_Work/Taisuke_Nakata/Zero_Lower_Bound/DeflationaryRegime/OptInf/draft/Figs/Fig_6
% OptInf_Alt_PsPd
%--------------------------------------------------------------------------
...
colors = {'k'};
% pd_string = {'p_D = 0.95','p_D = 0.975','p_D = 0.99'};
...
for i = 1:length(p_d)
    ...
    set(gca,'XLim',[0.99 1],'Ylim',[min_inf_targ_sun_demand cPItarg_max_ann],'FontSize',12)
    
end
line([line_vals(2) line_vals(2)],get(gca,'YLim'),'Color','k','LineStyle','-.','LineWidth',1)
line([line_vals(3) line_vals(3)],get(gca,'YLim'),'Color','k','LineStyle','-.','LineWidth',1)
